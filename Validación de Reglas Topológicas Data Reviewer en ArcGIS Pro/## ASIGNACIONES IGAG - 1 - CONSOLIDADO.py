...
# Created by: Kelly Villamil - Diego Rugeles (Supervisor Desarrollo DGIG) - Yaritza Quevedo - Michael Rojas 
...
R10 = arcpy.GetParameterAsText(11) #Bosque_Drenaj_L
T1 = arcpy.GetParameterAsText(12) #Cnivel_Piscin
T2 = arcpy.GetParameterAsText(13) #Bosque_Constr_R
...
V1 = arcpy.GetParameterAsText(2) #LVia_Deposito
V2 = arcpy.GetParameterAsText(3) #Via_Cercas
V3 = arcpy.GetParameterAsText(4) #ConstruccionR_ConstruccionP
V4 = arcpy.GetParameterAsText(5) #Vias_Deposito
V5 = arcpy.GetParameterAsText(6) #Deposito_DrenajeL
V6 = arcpy.GetParameterAsText(7) #Deposito_DrenajeR
V7 = arcpy.GetParameterAsText(8) #JagueyP_JagueyR
V8 = arcpy.GetParameterAsText(9) #Deposito_Deposito
