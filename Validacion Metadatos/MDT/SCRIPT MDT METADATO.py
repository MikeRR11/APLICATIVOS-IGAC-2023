...
if 'El modelo digital del terreno corresponde a una malla regular de puntos o celdas ráster espaciadas cada ' not in str(x) or ' cubre el Departamento de ' not in x or 'Se extiende a' not in x or ', El proceso se realizó con imágenes provenientes del sensor ' not in x or ' Fecha de toma ' not in x:
    error+=1
else:
    error=0
